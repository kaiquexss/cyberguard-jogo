...
<head>
  ...
  <meta name="description" content="Jogo educativo de navegador sobre boas práticas de cyber segurança: quiz, laboratório de senhas e detector de phishing."/>
  <style>
    :root{
      --bg:#0b1220;        /* fundo escuro */
      --panel:#101a30;     /* cartões */
      --muted:#96a3c0;     /* texto secundário */
